...
// Data
import dataCorporate from "layouts/reception/data/dataCorporate";
import { useHistory } from 'react-router-dom';

function CorporateCardTable() {
  ...
  return (
    <DashboardLayout>
      ...
      <VuiBox my={3}>
        ...
        <Card>
          <DataTable table={dataCorporate} entriesPerPage={false} canSearch />
        </Card>
      </VuiBox>
      <Footer />
    </DashboardLayout>
...
export default CorporateCardTable;
